    ...
    return (
        <div className="max-w-7xl mx-auto p-4 space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-base-content">Teacher Dashboard</h1>
            ...
            <div className="grid gap-4 md:grid-cols-3">
                <div className="bg-base-100 rounded-xl border border-base-300 p-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-2xl font-bold text-base-content">{totalClasses}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-base-100 rounded-xl border border-base-300 p-6">
                    <div className="flex items-center gap-3">
                        <div className="w-12 h-12 bg-green-500/20 rounded-xl flex items-center justify-center">
                            <HiUsers className="w-7 h-7 text-green-500" />
                        </div>
                        <div>
                            <p className="text-sm text-base-content/60">Total Students</p>
                            <p className="text-2xl font-bold text-base-content">{totalStudents}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-base-100 rounded-xl border border-base-300 p-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-sm text-base-content/60">Avg Students/Class</p>
            ...
            <div className="bg-base-100 rounded-xl border border-base-300 p-6">
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-lg font-semibold text-base-content">My Classes</h2>
                    <Link 
                        href="/teachers/class-schedule" 
                        className="btn btn-primary btn-sm gap-2"
                    >
                    ...
                    <div className="space-y-6">
                        {subjectRecords.map((record) => {
                            ...
                            return (
                                <div 
                                    key={record.id} 
                                    className="bg-base-50 rounded-xl border border-base-200 p-6 hover:shadow-md transition-shadow"
                                >
                                    {/* Class Header */}
                                    ...
                                    <div className="border-t border-base-200 pt-4">
                                        <div className="flex items-center justify-between mb-3">
                                            <h4 className="font-medium text-base-content">Class Roster</h4>
                                        ...
                                        {students.length === 0 ? (
                                            ...
                                            <div className="grid gap-2 md:grid-cols-2 lg:grid-cols-3">
                                                {students.map((student) => (
                                                    <div 
                                                        key={student.id}
                                                        className="flex items-center gap-3 p-3 bg-base-100 rounded-lg border border-base-200 hover:bg-base-200 transition-colors"
                                                    >
            ...
            <div className="bg-base-100 rounded-xl border border-base-300 p-6">
                <h2 className="text-lg font-semibold text-base-content mb-4">Class Statistics</h2>
