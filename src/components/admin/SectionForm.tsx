...
import { CreateSectionData, UpdateSectionData } from '../../services/sectionService';
    ...
    <div className="bg-base-100 rounded-xl shadow-lg border border-base-300">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-base-content/60">
              {mode === 'create' 
                ? 'Create a new section for this strand' 
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-6">
        ...
        <div className="space-y-2">
          <label htmlFor="sectionName" className="text-sm font-medium text-base-content">
            Section Name *
          </label>
          <input
            id="sectionName"
          ...
          />
          {errors.sectionName && (
            <p className="text-error text-xs">{errors.sectionName}</p>
          )}
        </div>
